# Stored Cross-Site Scripting (XSS) in endpoint `public_distrito_cad.php` parameter `nome`
...
![](/CVEs/images/storedXss1.png)

![](/CVEs/images/storedXss2.png)

![](/CVEs/images/storedXss3.png)
