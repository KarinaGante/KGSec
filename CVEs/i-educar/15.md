# Stored Cross-Site Scripting (XSS) in endpoint `TabelaArredondamento/edit` parameter `nome`
...
![](/CVEs/images/storedXss58.png)

![](/CVEs/images/storedXss59.png)

![](/CVEs/images/storedXss60.png)
