...
<p align="justify">Access vulnerable endpoint. Insert the payload in first field (<code>"Nome do Projeto"</code>) and second field (<code>"Observação"</code>). Click on <code>"Salvar"</code> and the trigger page will be activated automatically.</p>
...
![](/CVEs/images/storedXss54.png)

![](/CVEs/images/storedXss55.png)

![](/CVEs/images/storedXss56.png)

![](/CVEs/images/storedXss57.png)
